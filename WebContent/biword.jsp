...
<body>
    ...
    <div class="container">
    	...
    	<div style="text-align:center">
    		...
    		<h2>Biword Normal Search</h2>
    		<input name="nor_keyword1" type="text" id="nor_keyword1" value="">
    		<input name="type" type="hidden" value="normal">
    		<input name="isBiword" type="hidden" value="true">
    	...
    	<div style="text-align: center">
    		...
    		<option>Union</option>
    		<option>IntersectExcept</option>
    		<option>UnionExcept</option>
    		</select>
		...
		<p>No Result</p>
     	...
     	<c:if test="${!empty searchRes}">
		<c:forEach items="${searchRes }" var="itemm">
			<li>docid:${itemm.key} </br> <a href="file://${itemm.value}">${itemm.value}</a></li>
		</c:forEach>
		</c:if>
		</ul>
		<hr>
